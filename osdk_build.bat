...
::
ECHO.
ECHO Assembling VIP intro

SET OSDKLINK=
SET OSDKADDR=$c000
SET OSDKNAME=intro
SET OSDKFILE=main irq loader_api player buffers
SET OSDKDISK=
CALL %OSDK%\bin\make.bat %OSDKFILE%
copy build\final.out ..\build\files\intro.o
copy build\symbols ..\build\symbols_intro
...
SET OSDKLINK=-B
SET OSDKADDR=$c000
SET OSDKNAME=techtech
SET OSDKFILE=scroller main loader_api digiplayer  buffers
SET OSDKDISK=
CALL %OSDK%\bin\make.bat %OSDKFILE%
copy build\final.out ..\build\files\techtech.o
copy build\symbols ..\build\symbols_techtech
:blaskip
